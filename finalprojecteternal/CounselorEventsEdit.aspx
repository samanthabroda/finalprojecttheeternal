<%@ Page Title="" Language="C#" MasterPageFile="~/CounselorMaster.Master" AutoEventWireup="true" CodeBehind="CounselorEventsEdit.aspx.cs" Inherits="finalprojecteternal.CounselorEventsEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Events Manager (<a href="CounselorEvents.aspx">Done</a>)</h1>
