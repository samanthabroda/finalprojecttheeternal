<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AdminEditProfile.aspx.cs" Inherits="finalprojecteternal.AdminEditProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:HyperLink ID="hplEditProfile" runat="server" NavigateUrl="~/AdminProfile.aspx" style="text-decoration: underline; font-weight: 700">Back To Profile Page</asp:HyperLink>
    </p>
    <p>
    </p>
    <p>
