<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMaster.Master" AutoEventWireup="true" CodeBehind="StudentEvents.aspx.cs" Inherits="finalprojecteternal.StudentEvents" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Events</h1><asp:Label ID="warnMe" runat="server" Visible="false" Text="You are already RSVP'd!"></asp:Label>
