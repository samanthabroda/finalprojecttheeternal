...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Events (<a class="aandcOnly" href="CounselorEventsEdit.aspx">Edit</a>)</h1><asp:Label ID="warnMe" runat="server" Visible="false" Text="You are already RSVP'd!"></asp:Label>
